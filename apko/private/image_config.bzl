...
apko_config = rule(
    ...
    attrs = {
        "include": attr.label(allow_single_file = True, doc = """
        Config that should be used as the [include](https://github.com/chainguard-dev/apko/blob/main/docs/apko_file.md#includes).
        Note that if you want to use the include, the config itself should not contain it.
        """),
        "config": attr.label(allow_single_file = True, doc = """Config of the image. Either in source directory or generated by Bazel."""),
