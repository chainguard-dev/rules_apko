...
_ATTRS = {
    ...
    "architecture": attr.string(default = "host", doc = "the CPU architecture which this image should be built to run on. See https://github.com/chainguard-dev/apko/blob/main/docs/apko_file.md#archs-top-level-element", mandatory = True),
